...
time.sleep(1)
client.send_keypress(Key.B, Mod.LeftMeta)
time.sleep(0.1)
client.send_keypress(Key.Enter)
time.sleep(0.1)
client.send_keypress(Key.Enter)
time.sleep(0.1)
client.send_keypress(Key.L, Mod.LeftControl)
time.sleep(0.1)
client.send_ascii('youtube.com/watch?v=dQw4w9WgXcQ\n')
time.sleep(0.1)
client.send_keypress(Key.Enter)
time.sleep(1)
